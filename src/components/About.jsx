  ...
  return (
    <AboutSection>
      <article>
        <div></div>
        <div>
          <h2>About Recicle Bin</h2>
          <p>
            <strong>Recicle Bin</strong> este lindo juego nacio, de una idea
            eco-responsable, la cual desea enseñar a las nuevas y no tan nuevas
            generaciones la importancia de reciclar
          </p>
          <br />
          <br />
